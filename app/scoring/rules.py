...
def rule_risk_velocity(features: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
    """
    "Velocity" proxy without circular imports:
    - triggers if keyword score jumps sharply (max_user_keyword_delta)
      OR if there are multiple increase turns (fast ramp).
    """
